...
SELECT SUM(AMOUNT) FROM CUSTOMER_TRANSATIONS ;

SELECT SUM(AMOUNT) AS TOTAL_TRANSACTION FROM CUSTOMER_TRANSATIONS WHERE TRANSACTION_STATUS = 'COMPLETED';

-- MIN 

SELECT MIN(AMOUNT) AS MIN_TRANSACTIONS FROM CUSTOMER_TRANSATIONS;

-- MAXIMUM

SELECT MAX(AMOUNT) AS MAXIMUM_TRANSACTIONS FROM CUSTOMER_TRANSATIONS;

-- AVERAGE


SELECT AVG(AMOUNT) AS AVERAGE_TRANSACTIONS FROM CUSTOMER_TRANSATIONS;